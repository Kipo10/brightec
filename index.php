...
<html lang="en">
<head>
<title>BRIGHT GUEST HOUSE</title>
<!-- for-mobile-apps -->
...
<li><a href="https://plus.google.com/u/0/" class="fa fa-google-plus icon-border googleplus"> </a></li> 
	...
	<div class="contact-bnr-w3-agile">
				<ul>
<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">kipobright10@gmail.com</a></li>
<li><i class="fa fa-phone" aria-hidden="true"></i>+233 024-9524-491</li>	
<li class="s-bar">
<div class="search">
...
<h1><a class="navbar-brand" href="index.php">BRIGHT <span>GUEST HOUSE</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
</div>
...
<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4>BRIGHT  <span>GUEST HOUSE</span></h4>
...
<span class="cbp-ig-category">BRIGHT GUEST HOUSE</span>
						</div>
					</li>
					<li>
	<div class="w3_grid_effect">
...
<span class="cbp-ig-category">BRIGHT GUEST HOUST</span>
						</div>
					</li>
				</ul>
			</div>
...
<div class="ab-w3l-spa">
 <h3 class="title-w3-agileits title-black-wthree">About Our GUEST HOUSE</h3> <p class="about-para-w3ls"> text of the printing and typesetting industry.</p>
<img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
<div class="w3l-slider-img">
<img src="images/br.jpg" class="img-responsive" alt="Hair Salon">
										</div>
...
<img src="images/teams1.jpg" alt=" " class="img-responsive" />
					...
					<li>
<img src="images/alice.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+233(024)952-44-91</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com"><marquee direction="flip-left">kipobright10@gmail.com</marquee></a></p>
			<p class="contact-agile1"><strong>Address :</strong> Central Mosque , Jentilpe</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2022 BRIGHT GUEST HOUSE . All Rights Reserved | Design by <a href="index.php">Brighec</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
